...
/// background operation. No location data or PII ever transmitted. Anonymous
/// plugin telemetry enabled by default (easy opt-out).
///
/// ## Features
///
...
/// ```
///
/// See the [README](https://github.com/blackabass/polyfence-plugin) for more examples.
library polyfence;
