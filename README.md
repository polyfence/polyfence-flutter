...
# pubspec.yaml
dependencies:
  polyfence: <!-- pf:version -->^2.2.0<!-- /pf:version -->
```

**Current version:** <!-- pf:version-plain -->2.2.0<!-- /pf:version-plain -->
...
Polyfence.instance.onGeofenceEvent.listen((event) {
  switch (event.type) {
    ...
    case GeofenceEventType.signalLost:
      ...
      break;
    case GeofenceEventType.signalRestored:
      print('GPS restored, confirmed inside: ${event.zoneId}');
      break;
  }
});
```
...
print('Wake Lock Active: ${debugInfo.systemStatus.isWakeLockAcquired}'); // null on iOS
