      ...
      child: Column(
        ...
        children: [
          ...
          if (info != null) ...[
            ...
            const SizedBox(height: 8),
            _metricRow('Tracking', info.isTracking ? 'Active' : 'Stopped'),
            _metricRow('Zones', '${info.activeZones}'),
            _metricRow('Events', '${info.totalEventsGenerated}'),
            _metricRow('Profile', info.currentAccuracyProfile),
            _metricRow('Interval', '${info.currentIntervalMs}ms'),
          ],
